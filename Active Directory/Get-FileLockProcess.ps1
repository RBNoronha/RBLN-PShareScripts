function Get-FileLockProcess {
    ...
    if (! $(Test-Path $FilePath)) {
        Write-Error "O caminho $FilePath nao foi encontrado! Parando a execucao do comando."
...
"@
        ...
        if ($CheckMyCoreUtilsFileLockUtilLoaded -eq $null) {
            ...
            Write-Verbose "A classe Namespace MyCore.Utils FileLockUtil ja esta carregada e disponivel!"
        }
